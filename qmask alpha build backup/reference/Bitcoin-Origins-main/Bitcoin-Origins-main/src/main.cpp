...
const uint256 hashGenesisBlock("0x00000000d609826cd52e78b017bc0cdf4a33d61264facbea9f148c90e90a1c98");
...
string GetAppDir()
{
    ...
    {
        strDir = strprintf("%s\\BitcoinOrigins", getenv("APPDATA"));
    }
    else if (getenv("USERPROFILE"))
    {
        ...
        strDir = strprintf("%s\\BitcoinOrigins", strAppData.c_str());
    }
    else
    {
        return ".";
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        char* pszTimestamp = "Bitcoin Origins by Nicholas Magnabosco";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1786798800;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 626356395;
            ...
            block.print();
            assert(block.hashMerkleRoot == uint256("0xff70437c4bdab78064facbb5f4aa5d6718176ce5096349ec7a4d3b320f796cb9"));

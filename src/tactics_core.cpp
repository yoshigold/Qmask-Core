...
public:
    void ProcessPlayerInputMovement(char actionKey) {
        ...
        if (player.inShopMode == 1) {
            if (actionKey == '1' && player.persistentBankWalletQmtm >= 15.00) {
        ...
        if ((actionKey == 'p' || actionKey == 'P') && player.inCombatMode == 0) {
            player.inShopMode = 1; SaveStateToDisk(player); return;
        }
        ...
        if (player.xCoord == 12 && player.yCoord == 4 && player.diamond1Captured == 0) { 
            ...
            player.persistentBankWalletQmtm += 1.50; player.persistentEnergyJoules += 1000.00;
        }
        ...
        if (player.diamond1Captured == 1 && player.diamond2Captured == 1) {
            if (player.xCoord == player.randDiamondX && player.yCoord == player.randDiamondY && player.randDiamondCaptured == 0) {
                ...
                player.persistentBankWalletQmtm += 3.00; player.persistentEnergyJoules += 2000.00;
